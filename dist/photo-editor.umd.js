...
var EditorProvider = function (_a) {
    ...
    return (jsxRuntime.jsx(EditorContext$1.Provider, __assign({ value: {
            width: width,
            height: height,
...
var ToolsMap = [
    { icon: jsxRuntime.jsx(SvgIconPencil, {}), name: 'Pencil' },
    { icon: jsxRuntime.jsx(SvgIconWords, {}), name: 'Words' },
    { icon: jsxRuntime.jsx(SvgIconCut, {}), name: 'Cut' },
    { icon: jsxRuntime.jsx(SvgIconBlur, {}), name: 'Blur' },
    { icon: jsxRuntime.jsx(SvgIconRecall, {}), name: 'Recall' },
];
...
var Tile = function (_a) {
    ...
    return (jsxRuntime.jsx(reactKonva.Rect, { globalCompositeOperation: 'source-over', x: x, y: y, width: w, height: h, fill: "rgba(".concat(color.r, ", ").concat(color.g, ", ").concat(color.b, ", ").concat(color.a / 255, ")") }));
};
var Blurs = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [currentTiles.length > 0 && (jsxRuntime.jsx(reactKonva.Group, { children: currentTiles.map(function (tile, index) {
                    return tile && jsxRuntime.jsx(Tile, { tile: tile }, "".concat(index, "-").concat(tile.row, "-").concat(tile.column));
                }) })), bluredTiles.length > 0 && (jsxRuntime.jsx(reactKonva.Group, { children: bluredTiles.map(function (tile, index) {
                    return tile && jsxRuntime.jsx(Tile, { tile: tile }, "".concat(index, "-").concat(tile.row, "-").concat(tile.column));
                }) }))] }));
};
...
var WordInput = function (_a) {
    ...
    return ReactDOM__default["default"].createPortal(jsxRuntime.jsxs(WordInputModal, __assign({ onClick: function (e) { return e.stopPropagation(); } }, { children: [jsxRuntime.jsxs(InputActions, { children: [jsxRuntime.jsx("div", __assign({ onClick: handleCancel }, { children: "Cancel" })), jsxRuntime.jsx("div", __assign({ onClick: hanldeDone }, { children: "Done" }))] }), jsxRuntime.jsx(InputArea, { ref: textareaEl, autoComplete: 'off', wrap: 'hard', style: { color: textConfig.fill } }), jsxRuntime.jsx(ColorSelector, __assign({ viewprotHeight: viewprot.height }, { children: editorColors === null || editorColors === void 0 ? void 0 : editorColors.map(function (color) { return (jsxRuntime.jsx(ColorItem, { color: color, currentColor: textConfig.fill, onClick: function (e) { return handleChangeColor(e, color); } }, color)); }) }))] })), document.body);
};
...
var EditorStage = function () {
    ...
    var trRef = React.useRef(null);
    var lastDist = React.useRef(0);
    var lastTextScale = React.useRef(1);
    ...
    return (jsxRuntime.jsxs(StageContainer, __assign({ style: {
            width: width,
            height: height,
        } }, { children: [jsxRuntime.jsx(reactKonva.Stage, __assign({ ref: stage, width: width, height: height, onMouseDown: handleMouseDown, onTouchStart: handleTouchStart, onMouseMove: handleMouseMove, onTouchMove: handleTouchMove, onMouseUp: handleMouseUp, onTouchEnd: handleTouchEnd }, { children: jsxRuntime.jsxs(reactKonva.Layer, __assign({ ref: layer }, { children: [jsxRuntime.jsx(reactKonva.Group, __assign({ ref: scaleGroup, x: groupX, y: groupY, width: group.width, height: group.height, scale: {
                                x: basicScaleRatio,
                                y: basicScaleRatio,
                            }, rotation: group.rotation }, { children: jsxRuntime.jsxs(reactKonva.Group, __assign({ ref: clipGroup, clipX: clipRect.x, clipY: clipRect.y, clipHeight: clipRect.height, clipWidth: clipRect.width }, { children: [jsxRuntime.jsx(reactKonva.Image, { ref: currentImage, image: image, width: group.width, height: group.height }), jsxRuntime.jsx(Blurs, { currentBlur: currentBlurPos }), texts.map(function (text, index) { return (React.createElement(reactKonva.Text, __assign({}, text, { key: index, id: "text-".concat(index), x: text.x, y: text.y, draggable: true, onDragMove: handleTextDragMove, onDragEnd: handleTextDragEnd }))); }), lines.map(function (line, index) { return (jsxRuntime.jsx(reactKonva.Line, __assign({}, line), index)); })] })) })), jsxRuntime.jsx(reactKonvaUtils.Html, __assign({ groupProps: {
                                id: 'delete-area',
                                y: height - 120,
                                x: width / 2 - 75,
                                width: 150,
...
var HistoryProvider = function (_a) {
    ...
    return (jsxRuntime.jsx(EditorContext.Provider, __assign({ value: __assign(__assign({}, state), { image: mainImage, setGroup: handleGroupChange, setLines: handleLineChange, setBlurs: handleBlurChange, setTexts: handleTextChange, setImage: handleImagechange, redo: handleRedo, undo: handleUndo }) }, { children: isInt && children })));
};
