...
import { Stage, Layer, Group, Image, Text, Line, Rect, Transformer } from 'react-konva';
...
var EditorContext$1 = React.createContext({
    width: 0,
    height: 0,
    pencilConfig: {
        stroke: '#df4b26',
...
var EditorProvider = function (_a) {
    ...
    var _g = useState(null), activeTool = _g[0], setActiveTool = _g[1];
...
var WordInputContext = React.createContext({
    isShow: false,
    startInput: function () { },
});

var useWordInput = function () {
    var context = useContext(WordInputContext);
    return context;
};

var ToolsMap = [
    { icon: jsxRuntime.exports.jsx(IconPencil, {}), name: 'Pencil' },
    { icon: jsxRuntime.exports.jsx(IconWords, {}), name: 'Words' },
    { icon: jsxRuntime.exports.jsx(IconCut, {}), name: 'Cut' },
    { icon: jsxRuntime.exports.jsx(IconBlur, {}), name: 'Blur' },
    { icon: jsxRuntime.exports.jsx(IconRecall, {}), name: 'Recall' },
];
...
var ToolbarContainer = styled.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-evenly;\n  box-sizing: border-box;\n  width: 100%;\n  padding: 10px 0;\n"], ["\n  display: flex;\n  justify-content: space-evenly;\n  box-sizing: border-box;\n  width: 100%;\n  padding: 10px 0;\n"])));
var ToolbarItem = React.memo(styled.div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 50px;\n  height: 50px;\n  font-size: 14px;\n  font-weight: 400;\n  color: #fff;\n  line-height: 20px;\n  border: 1px solid transparent;\n  transition: all 0.3s ease-in-out;\n  svg {\n    width: 20px;\n    height: 20px;\n    margin-bottom: 2px;\n    fill: #fff;\n  }\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 50px;\n  height: 50px;\n  font-size: 14px;\n  font-weight: 400;\n  color: #fff;\n  line-height: 20px;\n  border: 1px solid transparent;\n  transition: all 0.3s ease-in-out;\n  svg {\n    width: 20px;\n    height: 20px;\n    margin-bottom: 2px;\n    fill: #fff;\n  }\n  ", "\n"])), function (props) {
    return props.isActive && css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n      color: #0096ff;\n      background: #e6f5ff;\n      box-shadow: 0px 0px 15px 0px rgba(0, 150, 255, 0.6);\n      border-radius: 5px;\n      border: 1px solid #0096ff;\n      svg {\n        fill: #0096ff;\n      }\n    "], ["\n      color: #0096ff;\n      background: #e6f5ff;\n      box-shadow: 0px 0px 15px 0px rgba(0, 150, 255, 0.6);\n      border-radius: 5px;\n      border: 1px solid #0096ff;\n      svg {\n        fill: #0096ff;\n      }\n    "])));
}));
...
var InputActions$1 = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: fixed;\n  bottom: 20px;\n  left: 0;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  padding: 12px 20px;\n  font-size: 16px;\n  font-weight: 400;\n  color: #ffffff;\n  line-height: 16px;\n  text-shadow: 0px 0px 1px rgba(0, 0, 0, 0.5);\n  z-index: 1000;\n  div {\n    position: relative;\n    &::after {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      display: block;\n      width: 200%;\n      height: 200%;\n      content: '';\n      transform: translate(-50%, -50%);\n    }\n  }\n"], ["\n  position: fixed;\n  bottom: 20px;\n  left: 0;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  padding: 12px 20px;\n  font-size: 16px;\n  font-weight: 400;\n  color: #ffffff;\n  line-height: 16px;\n  text-shadow: 0px 0px 1px rgba(0, 0, 0, 0.5);\n  z-index: 1000;\n  div {\n    position: relative;\n    &::after {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      display: block;\n      width: 200%;\n      height: 200%;\n      content: '';\n      transform: translate(-50%, -50%);\n    }\n  }\n"])));
var ClipStage = function (_a) {
    ...
    var _d = useState(clipRect), clipInfo = _d[0], setClipInfo = _d[1];
    var _e = useState(group.rotation), rotation = _e[0], setRotaion = _e[1];
    ...
    return (jsxRuntime.exports.jsxs(ClipContainer, { children: [jsxRuntime.exports.jsx(Stage, __assign({ ref: stageRef, width: width, height: height, scale: {
                    x: 0.96,
                    y: 0.96,
                }, x: width * 0.02, y: height * 0.02, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd }, { children: jsxRuntime.exports.jsxs(Layer, { children: [jsxRuntime.exports.jsxs(Group, __assign({ x: groupX, y: groupY, width: group.width, height: group.height, scaleX: basicScaleRatio, scaleY: basicScaleRatio, rotation: rotation }, { children: [jsxRuntime.exports.jsxs(Group, __assign({ ref: scaleGroup }, { children: [jsxRuntime.exports.jsx(Image, { ref: currentImage, image: image, width: group.width, height: group.height }), texts.map(function (text, index) { return (jsxRuntime.exports.jsx(Text, __assign({ draggable: true }, text), index)); }), lines.map(function (line, index) { return (jsxRuntime.exports.jsx(Line, __assign({}, line), index)); })] })), jsxRuntime.exports.jsx(Rect, { ref: reRef, x: clipInfo.x, y: clipInfo.y, width: clipInfo.width, height: clipInfo.height, fill: 'green', opacity: 0.3, onTransformEnd: handleTransformEnd })] })), jsxRuntime.exports.jsx(Transformer, { ref: trRef, rotateEnabled: false, anchorSize: 24 })] }) })), jsxRuntime.exports.jsxs(InputActions$1, { children: [jsxRuntime.exports.jsx("div", __assign({ onClick: hanldeCutCancel }, { children: "Cancel" })), jsxRuntime.exports.jsx(IconRotate, { width: 24, height: 24, onClick: hanldeRotate }), jsxRuntime.exports.jsx("div", __assign({ onClick: handleCutDown }, { children: "Done" }))] })] }));
};
var templateObject_1$2, templateObject_2$1;

var StageContainer = styled.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  background: #000;\n  &::before,\n  &::after {\n    position: absolute;\n    top: 0;\n    left: 0;\n    display: block;\n    width: 100%;\n    height: 180px;\n    content: '';\n    background: linear-gradient(180deg, rgba(34, 34, 34, 0.94) 0%, rgba(71, 71, 71, 0) 100%);\n    z-index: -1;\n    mix-blend-mode: darken;\n  }\n  &::after {\n    top: unset;\n    bottom: 0;\n    height: 180px;\n    background: linear-gradient(180deg, rgba(71, 71, 71, 0) 0%, #222222 100%);\n  }\n"], ["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  background: #000;\n  &::before,\n  &::after {\n    position: absolute;\n    top: 0;\n    left: 0;\n    display: block;\n    width: 100%;\n    height: 180px;\n    content: '';\n    background: linear-gradient(180deg, rgba(34, 34, 34, 0.94) 0%, rgba(71, 71, 71, 0) 100%);\n    z-index: -1;\n    mix-blend-mode: darken;\n  }\n  &::after {\n    top: unset;\n    bottom: 0;\n    height: 180px;\n    background: linear-gradient(180deg, rgba(71, 71, 71, 0) 0%, #222222 100%);\n  }\n"])));
var EditorStage = function () {
    ...
    return (jsxRuntime.exports.jsxs(StageContainer, { children: [jsxRuntime.exports.jsx(Stage, __assign({ ref: stage, width: width, height: height, onMouseDown: handleMouseDown, onTouchStart: handleTouchStart, onMouseMove: handleMouseMove, onTouchMove: handleTouchMove, onMouseUp: handleMouseUp, onTouchEnd: handleTouchEnd }, { children: jsxRuntime.exports.jsx(Layer, __assign({ ref: layer }, { children: jsxRuntime.exports.jsxs(Group, __assign({ id: 'scale', ref: scaleGroup, x: groupX, y: groupY, width: group.width, height: group.height, scale: {
                            x: basicScaleRatio,
                            y: basicScaleRatio,
                        }, rotation: group.rotation, clipX: clipRect.x, clipY: clipRect.y, clipHeight: clipRect.height, clipWidth: clipRect.width }, { children: [jsxRuntime.exports.jsx(Image, { ref: currentImage, image: image, width: group.width, height: group.height }), texts.map(function (text, index) { return (jsxRuntime.exports.jsx(Text, __assign({ draggable: true }, text), index)); }), lines.map(function (line, index) { return (jsxRuntime.exports.jsx(Line, __assign({}, line), index)); })] })) })) })), activeTool === 'Cut' && jsxRuntime.exports.jsx(ClipStage, { onCutDone: handleCut }), jsxRuntime.exports.jsx(Toolbar, { onAddText: handleTextAdd })] }));
};
...
var HistoryProvider = function (_a) {
    ...
    var _d = useImage(imageUrl), mainImage = _d[0], imageStatus = _d[1];
...
var ColorItemStyle = function (props) { return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background: ", ";\n  box-shadow: ", ";\n  border: ", ";\n"], ["\n  background: ", ";\n  box-shadow: ", ";\n  border: ", ";\n"])), props.color, props.color === props.currentColor ? '0px 0px 4px 0px rgba(0,150,255,1)' : 'none', props.color === props.currentColor ? '1px solid #0096FF;' : '1px solid #FFFFFF'); };
var ColorItem = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n  color: #fff;\n  background: #fff;\n  ", "\n  &::after {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    display: block;\n    width: 30px;\n    height: 30px;\n    transform: translate(-50%, -50%);\n    content: '';\n  }\n"], ["\n  position: relative;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n  color: #fff;\n  background: #fff;\n  ", "\n  &::after {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    display: block;\n    width: 30px;\n    height: 30px;\n    transform: translate(-50%, -50%);\n    content: '';\n  }\n"])), ColorItemStyle);
var ColorSelectorStyle = function (props) { return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  transform: translateY(calc(", "px - 100%));\n"], ["\n  transform: translateY(calc(", "px - 100%));\n"])), props.viewprotHeight - 20); };
...
var WordInputProvider = function (_a) {
    ...
    var _c = useState(false), isInputShow = _c[0], setIsInputShow = _c[1];
    ...
    return (jsxRuntime.exports.jsxs(WordInputContext.Provider, __assign({ value: {
            ...
            startInput: handleShow,
                ...
                ReactDOM.createPortal(jsxRuntime.exports.jsxs(WordInputModal, __assign({ onClick: function (e) { return e.stopPropagation(); } }, { children: [jsxRuntime.exports.jsxs(InputActions, { children: [jsxRuntime.exports.jsx("div", __assign({ onClick: handleCancel }, { children: "Cancel" })), jsxRuntime.exports.jsx("div", __assign({ onClick: hanldeDone }, { children: "Done" }))] }), jsxRuntime.exports.jsx(InputArea, { ref: textareaEl, autoComplete: 'off', wrap: 'hard', style: { color: textConfig.fill } }), jsxRuntime.exports.jsx(ColorSelector, __assign({ viewprotHeight: viewprot.height }, { children: editorColors === null || editorColors === void 0 ? void 0 : editorColors.map(function (color) { return (jsxRuntime.exports.jsx(ColorItem, { color: color, currentColor: textConfig.fill, onClick: function (e) { return handleChangeColor(e, color); } }, color)); }) }))] })), document.body)] })));
};
