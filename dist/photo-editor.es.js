...
var Tile = function (_a) {
    ...
    return (jsxRuntime.exports.jsx(Rect, { globalCompositeOperation: 'source-over', x: x, y: y, width: w, height: h, fill: "rgba(".concat(color.r, ", ").concat(color.g, ", ").concat(color.b, ", ").concat(color.a / 255, ")") }));
};
var Blurs = function (_a) {
    ...
    return (jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [currentTiles.length > 0 && (jsxRuntime.exports.jsx(Group, { children: currentTiles.map(function (tile, index) {
                    return tile && jsxRuntime.exports.jsx(Tile, { tile: tile }, "".concat(index, "-").concat(tile.row, "-").concat(tile.column));
                }) })), bluredTiles.length > 0 && (jsxRuntime.exports.jsx(Group, { children: bluredTiles.map(function (tile, index) {
                    return tile && jsxRuntime.exports.jsx(Tile, { tile: tile }, "".concat(index, "-").concat(tile.row, "-").concat(tile.column));
                }) }))] }));
};
...
var ClipStage = function (_a) {
    ...
    return (jsxRuntime.exports.jsxs(ClipContainer, { children: [jsxRuntime.exports.jsx(Stage, __assign({ ref: stageRef, width: width, height: height, scale: {
                    x: 0.96,
                    y: 0.96,
                }, x: width * 0.02, y: height * 0.02, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd }, { children: jsxRuntime.exports.jsxs(Layer, { children: [jsxRuntime.exports.jsxs(Group, __assign({ x: groupX, y: groupY, width: group.width, height: group.height, scaleX: basicScaleRatio, scaleY: basicScaleRatio, rotation: rotation }, { children: [jsxRuntime.exports.jsxs(Group, __assign({ ref: scaleGroup }, { children: [jsxRuntime.exports.jsx(Image, { ref: currentImage, image: image, width: group.width, height: group.height }), jsxRuntime.exports.jsx(Blurs, {}, 'clipBlur'), texts.map(function (text, index) { return (jsxRuntime.exports.jsx(Text, __assign({ draggable: true }, text), index)); }), lines.map(function (line, index) { return (jsxRuntime.exports.jsx(Line, __assign({}, line), index)); })] })), jsxRuntime.exports.jsx(Rect, { ref: reRef, x: clipInfo.x, y: clipInfo.y, width: clipInfo.width, height: clipInfo.height, fillPatternImage: clipRectFill, fillPriority: 'pattern', fillPatternScale: {
                                        x: 1 / basicScaleRatio,
                                        y: 1 / basicScaleRatio,
                                    }, onTransformEnd: handleTransformEnd })] })), jsxRuntime.exports.jsx(Transformer, { ref: trRef, rotateEnabled: false, anchorSize: 24 })] }) })), jsxRuntime.exports.jsxs(InputActions$1, { children: [jsxRuntime.exports.jsx("div", __assign({ onClick: hanldeCutCancel }, { children: "Cancel" })), jsxRuntime.exports.jsx(IconRotate, { width: 24, height: 24, onClick: hanldeRotate }), jsxRuntime.exports.jsx("div", __assign({ onClick: handleCutDown }, { children: "Done" }))] })] }));
};
...
var WordInput = function (_a) {
    ...
    return ReactDOM.createPortal(jsxRuntime.exports.jsxs(WordInputModal, __assign({ onClick: function (e) { return e.stopPropagation(); } }, { children: [jsxRuntime.exports.jsxs(InputActions, { children: [jsxRuntime.exports.jsx("div", __assign({ onClick: handleCancel }, { children: "Cancel" })), jsxRuntime.exports.jsx("div", __assign({ onClick: hanldeDone }, { children: "Done" }))] }), jsxRuntime.exports.jsx(InputArea, { ref: textareaEl, autoComplete: 'off', wrap: 'hard', style: { color: textConfig.fill } }), jsxRuntime.exports.jsx(ColorSelector, __assign({ viewprotHeight: viewprot.height }, { children: editorColors === null || editorColors === void 0 ? void 0 : editorColors.map(function (color) { return (jsxRuntime.exports.jsx(ColorItem, { color: color, currentColor: textConfig.fill, onClick: function (e) { return handleChangeColor(e, color); } }, color)); }) }))] })), document.body);
};
...
var EditorStage = function () {
    ...
    return (jsxRuntime.exports.jsxs(StageContainer, { children: [jsxRuntime.exports.jsx(Stage, __assign({ ref: stage, width: width, height: height, onMouseDown: handleMouseDown, onTouchStart: handleTouchStart, onMouseMove: handleMouseMove, onTouchMove: handleTouchMove, onMouseUp: handleMouseUp, onTouchEnd: handleTouchEnd }, { children: jsxRuntime.exports.jsxs(Layer, __assign({ ref: layer }, { children: [jsxRuntime.exports.jsxs(Group, __assign({ ref: scaleGroup, x: groupX, y: groupY, width: group.width, height: group.height, scale: {
                                x: basicScaleRatio,
                                y: basicScaleRatio,
                            }, rotation: group.rotation }, { children: [jsxRuntime.exports.jsxs(Group, __assign({ ref: clipGroup, clipX: clipRect.x, clipY: clipRect.y, clipHeight: clipRect.height, clipWidth: clipRect.width }, { children: [jsxRuntime.exports.jsx(Image, { ref: currentImage, image: image, width: group.width, height: group.height }), jsxRuntime.exports.jsx(Blurs, { currentBlur: currentBlurPos }), texts.map(function (text, index) { return (jsxRuntime.exports.jsx(Text, __assign({ id: "text-".concat(index) }, text, { x: text.x, y: text.y, draggable: true, onDragMove: handleTextDragMove, onDragEnd: handleTextDragEnd }), index)); }), lines.map(function (line, index) { return (jsxRuntime.exports.jsx(Line, __assign({}, line), index)); })] })), jsxRuntime.exports.jsx(Html, __assign({ groupProps: {
                                        id: 'delete-area',
                                        y: height - 120,
                                        x: width / 2 - 75,
                                        width: 150,
                                        ...
                                        // offsetX: groupX,
                                        // offsetY: groupY,
                                    } }, { children: jsxRuntime.exports.jsxs(DeleteArea, __assign({ deleteAreaStatus: deleteAreaStatus }, { children: [jsxRuntime.exports.jsx(IconDelete, {}), jsxRuntime.exports.jsx("div", { children: "Drag here to delete" })] })) }))] })), jsxRuntime.exports.jsx(Transformer, { ref: trRef, rotateEnabled: false, anchorStroke: 'rgba(0,0,0,0)', anchorFill: 'rgba(0,0,0,0)', borderStroke: '#ccc', keepRatio: true })] })) })), activeTool === 'Cut' && jsxRuntime.exports.jsx(ClipStage, { onCutDone: handleCut }), activeTool === 'Words' && (jsxRuntime.exports.jsx(WordInput, { onDone: handleTextAdd, onCancel: function () { return handleSelectTool(null); } })), deleteAreaStatus === 'none' && jsxRuntime.exports.jsx(Toolbar, {})] }));
};
